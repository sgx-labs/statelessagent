...
var KnownModels = []ModelInfo{
	...
	{"all-minilm", 384, "ollama", "Ultra-lightweight (~90MB, 384 dims). English-focused"},
	{"snowflake-arctic-embed", 1024, "ollama", "v1 large model"},
	{"embeddinggemma", 768, "ollama", "Best for phones and constrained hardware (<200MB RAM, <15ms, 250+ languages)"},
