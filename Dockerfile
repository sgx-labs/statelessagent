...
LABEL org.opencontainers.image.description="Persistent memory for AI coding agents. Local-first vault with semantic search, 17 MCP tools, and Claude Code hooks."
